...
export class FilterPipe implements PipeTransform {
    ...
    private filterByBoolean(filter: any) {
      return function (value: any) { return Boolean(value) === filter; };
    }

    private filterByObject(filter: any) {
      var _this = this;
      return function (value: { [x: string]: any; }) {
    ...
    private filterByOr(filter: any) {
      ...
      return function (value: string | any[]) {
          ...
          var /** @type {?} */ arrayComparison = function (i: string | number) { return value.indexOf(filter[i]) !== -1; };
          var /** @type {?} */ otherComparison = function (i: string | number) { return _this.isMatching(filter[i], value); };
    ...
    private filterDefault(filter: any) {
      return function (value: any) { return filter === undefined || filter == value; };
    }
